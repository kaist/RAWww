...
from .scrolling import (
    EdgeAutoScroller as _EdgeAutoScroller,
    MomentumScroller as _MomentumScroller,
    SmoothScrollArea as _SmoothScrollArea,
    SmoothScrollMixin as _SmoothScrollMixin,
    animate_scroll_to as _animate_scroll_to,
    kinetic_wheel_scroll as _kinetic_wheel_scroll,
)
...
class Workspace(QMainWindow):
    ...
    def _reset_unavailable_ai_filters(self) -> None:
        ...
        Панель AI и её группы скрываются, когда в папке нет лиц или оценок
        качества. Скрытый активный фильтр (например, порог качества) иначе
