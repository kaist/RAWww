...
FIXED_HOTKEYS: tuple[tuple[str, str], ...] = (
    ("Следующая вкладка", "Ctrl+Right"),
    ("Предыдущая вкладка", "Ctrl+Left"),
    ("Выйти из полного просмотра", "Esc или Enter"),
    ("Следующая фотография (полный просмотр)", "Right или Space"),
    ("Предыдущая фотография (полный просмотр)", "Left или Backspace"),
    ("Включить или выключить масштаб (полный просмотр)", "Z"),
    ("Воспроизведение видео или аудио (полный просмотр)", "Space"),
    ("Переключить фокус между папками и сеткой", "Tab"),
    ("Открыть выбранную папку", "Enter"),
    ("Копировать выбранные файлы", "Ctrl+C"),
    ("Вырезать выбранные файлы", "Ctrl+X"),
    ("Вставить файлы", "Ctrl+V"),
    ("Снять выделение", "Ctrl+D"),
    ("Удалить выбранный файл или папку", "Delete"),
)
